...
import tshirt1 from "../../assets/mesa-jacket (2).jpg";
...
import oatmealC from "../../assets/the-oatmeal-knit (2).JPG";
import heavyWeight from "../../assets/heavyWeight.jpg"
import machaChore from "../../assets/macha-chore.jpg"
      ...
      <div className="p-3 sm:p-4 md:p-6 flex flex-col flex-1">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[#0000004D] line-through text-xs sm:text-sm md:text-base">
              ${item.oldPrice}
            </span>
        ...
        ? allSections.map((section) => (
            <div key={section.title} className="mt-10">
              ...
              {chunkArray(section.products).map((row, idx) => (
                <div
                  key={idx}
                  className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 mb-6"
                >
                  {row.map((item) => (
